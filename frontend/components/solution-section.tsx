...
const features: Feature[] = [
  {
    ...
    title: "1 – Predict",
    description:
      "Before seeing any evidence, you must lock in your confidence level (0-100%) and explain your reasoning.",
  ...
  },
  {
    ...
    title: "2 – Investigate",
    description:
      "Receive a coaching hint tailored to the specific type of claim to guide your lateral reading.",
  ...
  },
  {
    ...
    title: "3 – Calibrate",
    description:
      "Compare your instinct against real sources and the AI's analysis, earning points for well-calibrated judgment.",
      ...
      <div className="max-w-7xl w-full px-6 md:px-12 lg:px-16 space-y-12">
        ...
        <div className="flex flex-col gap-4 max-w-[560px]">
          ...
          <h2 className="text-balance text-4xl md:text-5xl font-normal leading-[1.1] tracking-tight text-white">
            {"The GutCheck Loop".split(" ").map((word, i) => (
              <motion.span
                key={i}
          ...
          <p className="text-balance text-zinc-400 text-base leading-relaxed">
            A 90-second exercise designed to expose the gap between confidence and truth. By tracking your Brier score over time, GutCheck transforms media literacy from a passive lecture into an active, measurable habit.
          </p>
        </div>
