      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center justify-center px-6 md:px-12 lg:px-16">
        <div className="space-y-8 text-center flex flex-col items-center">
          ...
          <h2 className="text-balance text-5xl font-normal tracking-tight text-white md:text-6xl lg:text-5xl">
            {"AI Detectors Are Making Us Lazy".split(" ").map((word, i) => (
              <motion.span
                key={i}
          ...
          <p className="text-balance text-lg leading-relaxed text-gray-300 md:text-xl">
            When we rely on AI to spot AI, we outsource our own critical thinking. As hallucinations become indistinguishable from fact, a tool that simply says 'True' or 'False' teaches you nothing. You don't need a better algorithm; you need a better instinct.
          </p>
